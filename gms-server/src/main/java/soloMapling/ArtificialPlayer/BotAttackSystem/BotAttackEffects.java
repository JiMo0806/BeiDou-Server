...
public final class BotAttackEffects {
    ...
    public static boolean meleeStrike(Character bot, Map<Monster, List<Integer>> hits, int skillId,
        ...
        Packet packet = PacketCreator.botCloseRangeAttack(bot, skillId, skillLevel, facingMask,
    ...
    public static boolean rangedStrike(Character bot, Map<Monster, List<Integer>> hits, int skillId,
        ...
        Packet packet = PacketCreator.botRangedAttack(bot, skillId, skillLevel, facingMask,
    ...
    public static boolean magicStrike(Character bot, Map<Monster, List<Integer>> hits, int skillId,
        ...
        Packet packet = PacketCreator.botMagicAttack(bot, skillId, skillLevel, facingMask,
        ...
        for (MonsterDropEntry de : drops) {
            ...
            if (de.itemId == 0) { // meso
                ...
                if (mesos > 0) {
                    ...
                    map.spawnMesoDrop(mesos, pos, mob, bot, /* playerDrop */ false, dropType);
                    index++;
                }
            } else {
                Item item;
