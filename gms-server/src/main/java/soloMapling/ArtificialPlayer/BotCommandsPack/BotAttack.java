...
public final class BotAttack {
    ...
    public static void basicSwing(Character chr) {
        ...
        chr.getMap().broadcastMessage(
                chr,
                PacketCreator.botCloseRangeAttack(
                        chr,
                        /* skill        */ 0,
                        /* skilllevel   */ 0,
                        /* stance       */ facingMask,
    ...
    public static void skillSwing(Character chr, int skillId) {
        ...
        chr.getMap().broadcastMessage(
                chr,
                PacketCreator.botCloseRangeAttack(chr, skillId, resolveSkillLevel(skillId), facingMask,
    ...
    public static void magicSwing(Character chr, int skillId) {
        ...
        chr.getMap().broadcastMessage(
                chr,
                PacketCreator.botMagicAttack(chr, skillId, resolveSkillLevel(skillId), facingMask,
