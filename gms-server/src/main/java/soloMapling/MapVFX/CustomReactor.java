        ...
        for (ReactorDropEntry d : drops) {
            ...
            if (d.itemId == 0) {
                ...
                reactor.getMap().spawnMesoDrop(mesoDrop, reactor.getMap().calcDropPos(dropPos,
                        reactor.getPosition()), reactor, owner, false, (byte) 2);
            } else {
                Item drop;
                ...
                reactor.getMap().dropFromReactor(owner, reactor, drop, dropPos, (short) d.questid);
            }
        }
    }
    ...
    private static void delayedReactorDrops(Character owner, List<ReactorDropEntry> drops, Reactor reactor, Point dropPos) {
        ...
        for (ReactorDropEntry d : drops) {
            ...
            if (d.itemId == 0) {
                ...
                reactor.getMap().dropFromReactor(owner, reactor, drop, center2, (short) d.questid);
            }
            delay += 200;
            dropIndex++;
        }
