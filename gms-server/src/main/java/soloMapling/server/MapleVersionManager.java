...
public class MapleVersionManager {
    ...
    private static final String portalVersionYaml = "soloMapling-data/server/portal_versions.yaml";
    private static final String npcVersionYaml = "soloMapling-data/server/npc_versions.yaml";
